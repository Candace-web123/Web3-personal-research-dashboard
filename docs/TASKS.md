...
## 2.6 守边界版后续任务（TASK-024，未开始）

| 编号 | 名称 | 优先级 | 说明 |
|------|------|--------|------|
| TASK-023 | （已完成，见 2.5） | — | — |
| TASK-024 | 冒烟验收补强 / 墨刀 UI 设计稿 | P1/P2 | 019～023 功能齐后可做整体稿 |
...
**代码基线：** TASK-001～023 已完成；V1.2 首页主流程 + 复盘折叠区就绪。

**下一步：**

1. **TASK-024** — 墨刀首页 UI 设计稿（对齐当前 `app/page.tsx` 顺序与折叠区）
2. 或补充手动覆盖 UI（PRD 21.7，可单开 TASK）
